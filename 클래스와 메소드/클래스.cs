...
/*
 * using : 이름 공간을 사용해라
 * using 이름공간.이름공간; => 네임 스페이스를 앞에 붙이지 않아도 그 공간안에 있는 코드를 사용할수 있다.
 */
...
{ 
    ...
    namespace 수업내용
    {
        ...
        /*
         *  클래스
         *  사용자 정의 데이터 유형 입니다  -> int, float, string, char
         *  클래스를 이용하여 객체를 생성하고 그 객체 안에 내부에 있는 변수와 메소드를 이용하여 데이터에 접근하고 사용할수있는 집합체 입니다.
         */
